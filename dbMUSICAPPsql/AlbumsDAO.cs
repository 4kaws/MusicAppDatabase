...
namespace dbMUSICAPPsql
{
    internal class AlbumsDAO
    {
        ...
        public List<Album> GetAllAlbums() {
            ...
            //define thesql statement to fetch all albums
        ...
        internal int addOneAlbum(Album album)
        {
            ...
            //define thesql statement to fetch all albums
            MySqlCommand command = new MySqlCommand("INSERT INTO `albums`(`ALBUM_TITLE`, `ARTIST`, `YEAR`, `IMAGE_NAME`, `DESCRIPTION`) VALUES " +
        ...
        public List<Track> getTracksForAlbum(int albumID)
        {
            ...
            //define thesql statement to fetch all tracks
            MySqlCommand command = new MySqlCommand();
        ...
        public List<JObject> getTracksUsingJoin(int albumID)
        {
            ...
            //define thesql statement to fetch all tracksul
            MySqlCommand command = new MySqlCommand();
            command.CommandText = "SELECT tracks.ID as trackID, albums.ALBUM_TITLE, `track_title`, " +
                "`video_url`, `lyrics` FROM `tracks` JOIN " +
                "albums ON albums_ID = albums.ID WHERE albums_ID = @albumid";
            command.Parameters.AddWithValue("@albumid", albumID);
            command.Connection = connection;
        ...
        internal List<Track> getTracksUsingJoin()
        {
